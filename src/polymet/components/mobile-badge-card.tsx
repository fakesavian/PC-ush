...
export default function MobileBadgeCard({
  badge,
  onClick,
  ...
  return (
    <div className="relative">
      <button
        ...
        className={`
          relative w-full aspect-[4/5] p-2 rounded-xl border-2 transition-all duration-300 text-left group overflow-hidden min-h-[128px] max-h-[160px]
          ${
            badge.unlocked
